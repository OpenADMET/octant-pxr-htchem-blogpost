...
$$
\begin{aligned}
& \text{Eq. 1} \quad \text{Corrected EC}_{50}\text{ (M)} &&= \text{Crude EC}_{50}\text{ (M)} \times \text{Yield (\%)} \\[4pt]
& \text{Eq. 2} \quad \text{True Concentration (M)} &&= \text{Nominal Crude Concentration (M)} \times \text{Yield (\%)}
\end{aligned}
$$

![](<figures/static/Figure 2 - Yield Correction.gif>){width=100% group="blog-figures"}
...
![](<figures/static/Figure 3 - UHPLC-CAD-MS setup.png>){width=100% group="blog-figures"}
...
![](<figures/static/Figure 4 - Quinidine Salt.png>){width=55% fig-align="center" group="blog-figures"}
...
![](<figures/static/Figure 5 - CAD-corrected pEC50 Uncertainty.png>){width=100% group="blog-figures"}
...
::: {.column-page}
![](<figures/static/Figure 6 - Validation Experiment Comparisons.png>){width=100% group="blog-figures"}
:::
...
![](<figures/static/Figure 7 - ChemDraw SAR.png>){width=100% group="blog-figures"}
...
![](<figures/static/Figure 8 - HTChem Libraries.png>){width=100% group="blog-figures"}
...
The crude and semi-pure HTChem library data released with this post are also available on HuggingFace at [`openadmet/pxr-challenge-train-test`](https://huggingface.co/datasets/openadmet/pxr-challenge-train-test){target="_blank"}. They can be loaded with the [`datasets`](https://huggingface.co/docs/datasets){target="_blank"} library:
